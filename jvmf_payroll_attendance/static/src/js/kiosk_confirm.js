odoo.define('jvmf_payroll_attendance.kiosk_confirm', function (require) {
"use strict";
...
var KioskConfirm = AbstractAction.extend({
            ...
            this._rpc({
                ...
                .then(function(result) {
                    if (result.action) {
                        ...
                        setTimeout( function() { self.$('.o_hr_attendance_sign_in_out_icon').removeAttr("disabled"); }, 500);
                    }
                });
        },
    ...
    init: function (parent, action) {
        ...
        this.session.employee_id = this.employee_id;
        this.session.action_call_by = "kiosk_mode";
    },
